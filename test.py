...
def saveFile(id, day, goingoutLength,cookingLength,eatingLength,bathingLength,otherLength, pred, 
    ...
    data = [[day,goingoutLength,cookingLength,eatingLength,bathingLength,otherLength,sleepingLength,pred,timeLeft,sleepHourStart, str(sleepHourStart)+':'+ str(sleepMinStart), str(sleepHourEnd)+':'+ str(sleepMinEnd),
        goingoutLengthPre,cookingLengthPre,eatingLengthPre,bathingLengthPre,otherLengthPre,]]
